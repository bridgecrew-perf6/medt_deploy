...
export const getAdminProductPrice = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get("/api/v1/admin/productPrices");
...
// Update ProductPrice
export const updateProductPrice = (id, productPriceData) => async (dispatch) => {
  try {
...
export const deleteProductPrice = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(`/api/v1/admin/productPrice/${id}`);
...
export const getProductPriceDetails = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`/api/v1/productPrice/${id}`);
...
export const getProductPriceDetailsByZoneId = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`/api/v1/productPriceByZone/${id}`);
    dispatch({
...
export const getProductPriceDetailsByProductId = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`/api/v1/productPriceByProduct/${id}`);
    dispatch({
