...
export const getAdminDrugPrice = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get("/api/v1/admin/drugPrices");
...
export const deleteDrugPrice = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(`/api/v1/admin/drugPrice/${id}`);
...
export const getDrugPriceDetails = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`/api/v1/drugPrice/${id}`);
...
export const getDrugPriceDetailsByZoneId = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`/api/v1/drugPriceByZone/${id}`);
    dispatch({
...
export const getDrugPriceDetailsByDrugId = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`/api/v1/drugPriceByDrug/${id}`);
    dispatch({
