...
export const drugPriceReducer = (state = {}, action) => {
  switch (action.type) {
    ...
    case UPDATE_DRUG_PRICE_BY_DRUG_ZONE_ID_REQUEST:
      return {
        ...state,
        loading: true,
      };
    ...
    case UPDATE_DRUG_PRICE_BY_DRUG_ZONE_ID_SUCCESS:
      return {
        ...state,
        loading: false,
    ...
    case UPDATE_DRUG_PRICE_BY_DRUG_ZONE_ID_FAIL:
      return {
        ...state,
        loading: false,
        error: action.payload,
    ...
    case UPDATE_DRUG_PRICE_BY_DRUG_ZONE_ID_RESET:
      return {
        ...state,
        isUpdated: false,
      };
...
export const drugPriceDetailsReducer = (state = { drugPrice: {} }, action) => {
  switch (action.type) {
    ...
    case DRUG_PRICE_DETAILS_BY_DRUG_ZONE_ID_REQUEST:
      return {
        loading: true,
        ...state,
      };
    ...
    case DRUG_PRICE_DETAILS_BY_DRUG_ZONE_ID_SUCCESS:
      return {
        loading: false,
    ...
    case DRUG_PRICE_DETAILS_BY_DRUG_ZONE_ID_FAIL:
      return {
        loading: false,
        error: action.payload,
      };
