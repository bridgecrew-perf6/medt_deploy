...
const GeneralCouponList = () => {
  ...
  useEffect(() => {
    ...
    if (isDeleted) {
      alert.success("GeneralCoupon Deleted Successfully");
          ...
          <div className="col-12">
            <div className="card card-light">
              <div className="card-header">
                <h3 className="card-title">List of GeneralCoupon</h3>
              </div>
              {/* /.card-header */}
...
export default GeneralCouponList;
