...
import GeneralCouponList from "./GeneralCouponList";
import Loader from "../../components/loader/Loader";

function GeneralCoupon() {
  ...
  useEffect(() => {
    ...
    if (success) {
      alert.success("GeneralCoupon added successfully");
  ...
  return (
    <>
      <MetaData title="GeneralCoupon" />
      {loading ? (
        <Loader />
      ) : (
        <div className="content-wrapper">
          <ContentHeader title="GeneralCoupon" />
          <section className="content">
            <div className="container-fluid">
              {/* Adding GeneralCoupon */}
              <div classname="row">
                <div className="card card-success">
                  <div className="card-header">
                    <h3 className="card-title">Add GeneralCoupon</h3>
                  </div>
                  {/* /.card-header */}
              ...
              {/* GeneralCoupon Table */}
              {loading ? <Loader /> : <GeneralCouponList />}
            </div>
          </section>
        </div>
      )}
