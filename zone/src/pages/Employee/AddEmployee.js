...
export default function AddEmployee() {
  ...
  }, [dispatch, alert, error, success, reset]);
                              ...
                              {...register("password", {
                                ...
                                pattern: {
                                  value:
                                    /^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{8,}$/i,
                                  message:
                                    "Password must be at least 8 characters long, contain at least one number, at least one symbol and have a mixture of uppercase and lowercase letters",
                                },
                              })}
                              className={classNames("form-control", {
