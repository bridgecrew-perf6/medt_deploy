...
export default function BookedOrders() {
        ...
        return (
          <>
            ...
            {/* <Link
              ...
              onClick={() =>
                navigate(
                  `/order-items-details/${params.getValue(params.id, "id")}`
                )
              }
            >
  ...
  orders &&
    orders.forEach((order) => {
      if (order.zoneId === employee.zoneId && order.orderStatus === 1) {
        rows.push({
          serial: count++,
          id: order._id,
  ...
  return (
    <Fragment>
      {loading ? (
        ...
        <>
          <MetaData title="BookedOrder" />
          <div className="content-wrapper">
            <ContentHeader title="BookedOrder" />
                  ...
                  <div className="col-12">
                    <div className="card">
                      <div className="card-header">
                        <h3 className="card-title">BookedOrder Details</h3>
                      </div>
                      {/* /.card-header */}
