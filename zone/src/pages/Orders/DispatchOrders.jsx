...
export default function DispatchOrders() {
  ...
  orders &&
    orders.forEach((order) => {
      if (order.zoneId === employee.zoneId && order.orderStatus === 3) {
        rows.push({
          serial: count++,
          id: order._id,
  ...
  return (
    <Fragment>
      {loading ? (
        ...
        <>
          <MetaData title="DispatchOrder" />
          <div className="content-wrapper">
            <ContentHeader title="DispatchOrder" />
                  ...
                  <div className="col-12">
                    <div className="card">
                      <div className="card-header">
                        <h3 className="card-title">DispatchOrder Details</h3>
                      </div>
                      {/* /.card-header */}
