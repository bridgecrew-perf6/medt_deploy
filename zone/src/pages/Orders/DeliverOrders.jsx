...
export default function DeliverOrders() {
  ...
  orders &&
    orders.forEach((order) => {
      if (order.zoneId === employee.zoneId && order.orderStatus === 4) {
        rows.push({
          serial: count++,
          id: order._id,
  ...
  return (
    <Fragment>
      {loading ? (
        ...
        <>
          <MetaData title="DeliverOrder" />
          <div className="content-wrapper">
            <ContentHeader title="DeliverOrder" />
                  ...
                  <div className="col-12">
                    <div className="card">
                      <div className="card-header">
                        <h3 className="card-title">DeliverOrder Details</h3>
                      </div>
                      {/* /.card-header */}
