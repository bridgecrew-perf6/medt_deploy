...
export default function DeliveredOrders() {
  ...
  orders &&
    orders.forEach((order) => {
      if (order.zoneId === employee.zoneId && order.orderStatus === 5) {
        rows.push({
          serial: count++,
          id: order._id,
  ...
  return (
    <Fragment>
      {loading ? (
        ...
        <>
          <MetaData title="DeliveredOrder" />
          <div className="content-wrapper">
            <ContentHeader title="DeliveredOrder" />
                  ...
                  <div className="col-12">
                    <div className="card">
                      <div className="card-header">
                        <h3 className="card-title">DeliveredOrder Details</h3>
                      </div>
                      {/* /.card-header */}
