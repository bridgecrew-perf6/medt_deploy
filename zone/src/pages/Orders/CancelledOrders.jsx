...
export default function CancelledOrders() {
  ...
  orders &&
    orders.forEach((order) => {
      if (order.zoneId === employee.zoneId && order.orderStatus === 0) {
        rows.push({
          serial: count++,
          id: order._id,
  ...
  return (
    <Fragment>
      {loading ? (
        ...
        <>
          <MetaData title="CancelledOrder" />
          <div className="content-wrapper">
            <ContentHeader title="CancelledOrder" />
                  ...
                  <div className="col-12">
                    <div className="card">
                      <div className="card-header">
                        <h3 className="card-title">CancelledOrder Details</h3>
                      </div>
                      {/* /.card-header */}
