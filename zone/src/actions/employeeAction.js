...
export const createEmployee = (employeeData) => async (dispatch) => {
  try {
    ...
    const { data } = await axiosInstance.post(
      `/api/v1/employee/employee/register`,
      employeeData,
      config
    );
...
export const loadEmployee = () => async (dispatch) => {
  try {
    ...
    const { data } = await axiosInstance.get(`/api/v1/employee/me`);
...
export const logout = () => async (dispatch) => {
  try {
    await axiosInstance.get(`/api/v1/employee/logout`);
...
export const updateProfile = (employeeData) => async (dispatch) => {
  try {
    ...
    const { data } = await axiosInstance.put(`/api/v1/employee/me/update`, employeeData, config);
...
export const updatePassword = (passwords) => async (dispatch) => {
  try {
    ...
    const { data } = await axiosInstance.put(
      `/api/v1/employee/password/update`,
      passwords,
      config
    );
...
export const forgotPassword = (email) => async (dispatch) => {
  try {
    ...
    const { data } = await axiosInstance.post(`/api/v1/employee/password/forgot`, email, config);
...
export const resetPassword = (token, passwords) => async (dispatch) => {
  try {
    ...
    const { data } = await axiosInstance.put(
      `/api/v1/employee/password/reset/${token}`,
      passwords,
      config
    );
...
export const getAllEmployees = () => async (dispatch) => {
  try {
    ...
    const { data } = await axiosInstance.get(`/api/v1/employee/admin/employees`);
...
export const getEmployeeDetails = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axiosInstance.get(`/api/v1/employee/admin/employee/${id}`);
...
export const updateEmployee = (id, employeeData) => async (dispatch) => {
  try {
    ...
    const { data } = await axiosInstance.put(
      `/api/v1/employee/admin/employee/${id}`,
      employeeData,
      config
    );
...
export const deleteEmployee = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axiosInstance.delete(`/api/v1/employee/admin/employee/${id}`);
