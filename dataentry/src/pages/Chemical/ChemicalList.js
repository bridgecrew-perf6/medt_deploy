...
import { getChemicals, clearErrors, deleteChemical } from "../../actions/chemicalAction";
...
const ChemicalList = () => {
  ...
  const { error: deleteError, isDeleted, loading } = useSelector((state) => state.chemical);
  ...
  useEffect(() => {
    ...
    if (isDeleted) {
      alert.success("Chemical Deleted Successfully");
          ...
          <div className="col-12">
            <div className="card card-light">
              <div className="card-header">
                <h3 className="card-title">List of Chemical</h3>
              </div>
              {/* /.card-header */}
