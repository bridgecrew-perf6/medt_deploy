...
import { createProductPrice } from "../../actions/productPriceAction";
...
export default function AddProduct() {
  ...
  const countries = ["India", "China", "America", "Zapan", "Russia", "Ukrain"];
  // const zones = ["India", "China", "America", "Zapan", "Russia", "Ukrain"];
  ...
  const onSubmit = (formData) => {
    ...
    productsForm.set("zoneId", employee.zoneId);
    productsForm.set("user", employee._id);
